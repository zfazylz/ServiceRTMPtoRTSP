...
class StreamConverter:
    ...
    def __init__(self, rtmp_url: str, rtsp_port: int, stream_name: str):
        """
...
class StreamManager:
    ...
    def add_stream(self, rtmp_url: str, rtsp_port: int, stream_name: str) -> bool:
        """
        ...
        converter = StreamConverter(rtmp_url, rtsp_port, stream_name)
